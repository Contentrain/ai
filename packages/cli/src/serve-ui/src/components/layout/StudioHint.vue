...
<template>
  <div
    v-if="visible"
    class="flex items-center justify-between gap-3 rounded-lg border border-status-info/20 bg-gradient-to-b from-status-info/5 to-transparent px-4 py-3"
  >
