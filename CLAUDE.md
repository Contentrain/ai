...
├── templates/
│   ├── astro-starter/ — Astro + Contentrain base for migrations; standalone (own lockfile), gated by scripts/starter-gates.mjs
│   └── fixtures/      — content laid over the starter in CI (wp-demo)
├── plugins/
