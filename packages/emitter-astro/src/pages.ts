...
<Layout
  ...
  css={page.css ?? []}
  lang={${locale}}${seo ? `
  seo={{ description: page.description, image: page.image, imageMeta: page.image_meta, canonical: page.canonical, breadcrumbs: page.breadcrumbs, noindex: page.noindex, nofollow: page.nofollow, type: 'website', pageType: 'CollectionPage' }}` : ''}
/>
`
}
