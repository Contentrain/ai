  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'models', name: 'models', component: () => import('./components/pages/ModelsPage.vue') },
        {
          ...
          meta: { subSidebar: true, basePath: '/models', paramKey: 'modelId' },
        },
        { path: 'content', name: 'content', component: () => import('./components/pages/ContentPage.vue') },
        {
          path: 'content/:modelId',
          name: 'content-list',
          component: () => import('./components/pages/ContentListPage.vue'),
          meta: { subSidebar: true, basePath: '/content', paramKey: 'modelId' },
        },
